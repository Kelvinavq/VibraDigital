      ...
      <div class="large-container"  data-aos="fade-up">
        <div class="testimonial-carousel owl-carousel owl-theme">
          <div class="testimonial-block">
            <div class="inner-box">
              <div class="text">
                Estoy impresionada con el profesionalismo y la creatividad de Vibra Digital. Han transformado por completo nuestra presencia en línea y han superado todas nuestras expectativas. ¡Gracias!
              </div>
              <div class="info-box">
                <div class="thumb">
                  <img
                ...
                <h4 class="name">María Martínez</h4>
          ...
          <div class="testimonial-block">
            <div class="inner-box">
              <div class="text">
                Contratamos a Vibra Digital para un proyecto de desarrollo web complejo y no podríamos estar más satisfechos. El equipo demostró una gran habilidad técnica y una comunicación excepcional en cada etapa del proyecto. Recomendaría sus servicios sin dudarlo.
              </div>
              <div class="info-box">
                <div class="thumb">
                  <img
                ...
                <h4 class="name">Juan González</h4>
                <span class="designation"></span>
              </div>
            </div>
          </div>
          ...
          <div class="testimonial-block">
            <div class="inner-box">
              <div class="text">
                Desde la primera reunión con Vibra, supe que estábamos en buenas manos. La atención al detalle y el compromiso con la calidad son evidentes en cada línea de código. [Nombre de tu Agencia] no solo entregó un sitio web asombroso, sino que también brindó un servicio al cliente excepcional.
              </div>
              <div class="info-box">
                <div class="thumb">
                  <img
        ...
        <div class="thumb-layer paroller">
          <figure class="image">
            <img
              src="assets/img/user-thumbs.png"
              alt=""
            />
          </figure>
        </div>
